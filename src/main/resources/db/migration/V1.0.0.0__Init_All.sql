...
CREATE TABLE some_documents(
    ...
    some_well_defined_json_array jsonb NOT NULL,
    some_custom_json_array jsonb NOT NULL
);


INSERT INTO some_documents
    (some_documents_id, some_value, some_well_defined_json, some_custom_json,
     some_well_defined_json_array, some_custom_json_array) VALUES
('9c095f99-58ed-4d4a-9a19-199486dfad23', 'some value 1',
 ...
 '[{"first_name": "Heriberto", "last_name": "Reyes", "some_desc":  "My Desc 1"},{"first_name": "Angie", "last_name": "Flores", "some_desc":  "My Desc 2"}]',
 '[{"name": "Some Name.", "type": "Some Type."},{"author": "Some nice Author", "birthday": "1892-03-05"}]'
 ),
