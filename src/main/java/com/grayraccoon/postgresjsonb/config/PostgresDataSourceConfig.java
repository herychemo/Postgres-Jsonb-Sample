package com.grayraccoon.postgresjsonb.config;
...
@EnableJpaRepositories(
        ...
        basePackages = { "com.grayraccoon.postgresjsonb.data.postgres.repository" }    // Repository Package
)
@Profile("!default")
public class PostgresDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        return builder
                ...
                .packages("com.grayraccoon.postgresjsonb.data.postgres.domain")    // Domain Package
